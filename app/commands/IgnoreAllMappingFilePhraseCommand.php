...
class IgnoreAllMappingFilePhraseCommand extends Service {
    public function actionIndex() {
        ## Put your code here
        $phrase = $this->params['phrase'];
        
        Yii::app()->db->createCommand("INSERT INTO exceptions VALUES(DEFAULT,null,'".$phrase."')")->execute();
        Yii::app()->db->createCommand("UPDATE c_mapping_file SET is_ignored= 'Y' WHERE phrase = '".$phrase."' ")->execute();
