...
<div class="top-bar" onload="getTime()">
     <div id="desktop-menu">
         ...
         <?php
            $html = '';
            $html .= '<li><img src="app/static/img/logo.png" style="width: 35px; margin-left: 10px;"></li>';
            if (@Yii::app()->user->info['role'] != 'dev') {
                $html .= '<li><a href="index.php?r=site/home"><i class="fa fa-home"></i> Halaman Awal</a></li>';
                $html .= '<li><a href="index.php?r=site/about"><i class="fa fa-info-circle"></i> Seputar Halaman</a></li>';
            }
            ...
            if (Yii::app()->user->role == 'kps') {  
                if (sizeof(Yii::app()->user->info['roles']) > 1) {
                    $html .= '<li>';  
                    $html .= '<a ng-url="sys/profile/changeRole&id=3"><i class="fa fa-refresh"></i> Switch To Dosen</a>';     
                    $html .= '</li>';
                }
            }  
            if (Yii::app()->user->role == 'dsn') {  
                if (sizeof(Yii::app()->user->info['roles']) > 1) {
                    $html .= '<li>';  
                    $html .= '<a ng-url="sys/profile/changeRole&id=5"> <i class="fa fa-refresh"></i> Switch To KPS</a>';     
                    $html .= '</li>';
                }
            }  
